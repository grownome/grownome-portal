...
reports, feature requests and any other information to "
   ...
   [b/Card  {:style {"overflow"  "hidden"
    ...
    [b/CardBody {:style {"paddingTop" "20px"
     ...
     [:h2 "'Dryness Predictor' analyzes your images to predict how dry your plants are. Try it out and let us know what you think of it. This is an alpha feature that we are constantly improving."]]]]
   [:br]
